...
import org.superchat.server.user.mapper.UserApplyMapper;

import java.util.List;

import static org.superchat.server.user.domain.enums.ApplyReadStatusEnum.READ;
import static org.superchat.server.user.domain.enums.ApplyReadStatusEnum.UNREAD;
import static org.superchat.server.user.domain.enums.ApplyStatusEnum.AGREE;
